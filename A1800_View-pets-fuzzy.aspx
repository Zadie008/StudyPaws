<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="A1800_View-pets-fuzzy.aspx.cs" Inherits="Default2" %>
                ...
                <table>
                    <tr>
                        <td><div class="petIcon">
                                ...
                                <img class="petImage" src="Images/Fuzzy 1.png" width="120"/>
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div class="petCircle"></div>
                                <img class="petImage" src="Images/Fuzzy 2.png" width="120"/>
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div class="petCircle"></div>
                                <img class="petImage" src="Images/Fuzzy 3.png" width="120"/>
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div class="petCircle"></div>
                                <img class="petImage" src="Images/Fuzzy 4.png" width="120"/>
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div class="petCircle"></div>
                                <img class="petImage" src="Images/Fuzzy 5.png" width="120"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
