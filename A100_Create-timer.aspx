<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="A100_Create-timer.aspx.cs" Inherits="Default2" %>
    ...
    <div class="createTimerMainContent">
        <div class="buttonSection">
            ...
            <div class="rightSection">
                <asp:Button ID="btnViewPastTimers" class="button" runat="server" Text="View past timers" OnClick="btnViewPastTimers_Click" />
            </div>
        </div>
    </div>
</asp:Content>
