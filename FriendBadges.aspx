<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FriendBadges.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="mainContentPlaceHolder" runat="Server">
    <div id="friendsBadgesPage">
        <h2>
            <asp:Label ID="lblPageTitle" runat="server" Text="Badges"></asp:Label></h2>
        <div class="backgroundColorContainer">
            <div class="scrollableTableContainer">
                <div class="friends-badges-grid">
                    <asp:Repeater ID="rpPets" runat="server">
                        <ItemTemplate>
                            <div class="friend-badge-card">
                                <div class="friend-badge-image">
                                ...
                                <asp:Label ID="lblBadgeName" runat="server" Text='<%# Eval("badgeName") %>' CssClass="friend-badge-name"></asp:Label>
                                <asp:Label ID="lblBadgeDescription" runat="server"
                                    Text='<%# Eval("badgeDescription") %>'
                                    CssClass="friend-badge-description"></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
