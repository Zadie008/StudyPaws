            ...
            <div class="middleSection">
                <div class="SearchFriends">
                    <div class="buttonSection">
                        <asp:Button ID="btnSearchFriends" class="button" runat="server" Text="Search Friends" OnClick="btnSearchFriends_Click" />
                    </div>
                </div>
            </div>
            <div class="rightSection viewFriendshipsMessages">
                <img src="Icons/icons8-mail-white-96.png" alt="Messages" />
            </div>
        </div>
