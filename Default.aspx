...
<asp:Content ID="Content2" ContentPlaceHolderID="headerContentPlaceHolder" Runat="Server">
    ...
    <div class="accountInfoDiv">
        ...
        <div class="timeDateDiv">
            <table>
                <tr>
                    <td colspan="2"><asp:Label ID="lblTime" runat="server" Text="--:--" Font-Size="65"></asp:Label></td> <!--CHANGE: has to be current time-->
                    <td></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblDay" runat="server" Text="Day"></asp:Label></td> <!--CHANGE: has to be current day-->
                    <td><asp:Label ID="lblDate" runat="server" Text="Date"></asp:Label></td> <!--CHANGE: has to be current date-->
                </tr>
            </table>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    <div class="homePagePet">
        <img id="pet" src="Images/Cat%201%20Brown%20and%20White.gif" width="400" /> <!--CHANGE: has to be chosen home page pet-->
