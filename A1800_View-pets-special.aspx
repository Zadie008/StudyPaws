<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="A1800_View-pets-special.aspx.cs" Inherits="View_Pets_special" %>
                ...
                <table>
                    <tr>
                        <td><div class="petIcon">
                                ...
                                <asp:Image ID="imgPet1" runat="server" CssClass="petImage" ImageUrl="Images/Special 1.png" Width="130" />
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div id="circle2" class="petCircle" runat="server"></div>
                                <asp:Image ID="imgPet2" runat="server" CssClass="petImage" ImageUrl="Images/Special 2.png" Width="130" />
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div id="circle3" class="petCircle" runat="server"></div>
                                <asp:Image ID="imgPet3" runat="server" CssClass="petImage" ImageUrl="Images/Special 3.png" Width="130" />
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div id="circle4" class="petCircle" runat="server"></div>
                                <asp:Image ID="imgPet4" runat="server" CssClass="petImage" ImageUrl="Images/Special 4.png" Width="130" />
                            </div>
                        </td>
                        <td>
                            <div class="petIcon">
                                <div id="circle5" class="petCircle" runat="server"></div>
                                <asp:Image ID="imgPet5" runat="server" CssClass="petImage" ImageUrl="Images/Special 5.png" Width="130" />
                            </div>
                        </td>
                    </tr>
                    <tr>
