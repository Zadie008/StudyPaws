<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="B1400_View-shop-dogs.aspx.cs" Inherits="B1400_View_shop_dogs" %>
        ...
        <table>
            <tr>
                <td><div class="petIconShop">
                        ...
                        <asp:Image ID="imgPet1" runat="server" CssClass="petImageShop" ImageUrl="Images/Dog 1.png" Width="130" />
                    </div>
                </td>
                <td>
                    <div class="petIconShop">
                        <div id="circle2" class="petCircleShop" runat="server"></div>
                        <asp:Image ID="imgPet2" runat="server" CssClass="petImageShop" ImageUrl="Images/Dog 2.png" Width="130" />
                    </div>
                </td>
                <td>
                    <div class="petIconShop">
                        <div id="circle3" class="petCircleShop" runat="server"></div>
                        <asp:Image ID="imgPet3" runat="server" CssClass="petImageShop" ImageUrl="Images/Dog 3.png" Width="130" />
                    </div>
                </td>
                <td>
                    <div class="petIconShop">
                        <div id="circle4" class="petCircleShop" runat="server"></div>
                        <asp:Image ID="imgPet4" runat="server" CssClass="petImageShop" ImageUrl="Images/Dog 4.png" Width="130" />
                    </div>
                </td>
                <td>
                    <div class="petIconShop">
                        <div id="circle5" class="petCircleShop" runat="server"></div>
                        <asp:Image ID="imgPet5" runat="server" CssClass="petImageShop" ImageUrl="Images/Dog 5.png" Width="130" />
                    </div>
                </td>
            </tr>
            <tr>
...
<asp:Label ID="lblLocked" class="button" runat="server" Text="UNLOCKS AT LEVEL 5" Visible="false" />
    </div>
